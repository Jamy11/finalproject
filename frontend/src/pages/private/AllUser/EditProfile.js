...
const EditProfile = () => {
    ...
    const onSubmit = data => {
        ...
        axios.post(`${process.env.REACT_APP_BACKEND_URL}/updateuser`, {...data, email: user.primaryEmailAddress.emailAddress})
