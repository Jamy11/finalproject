...
const AddCategory = () => {
  ...
  const onSubmit = data => {
    const categoryData = { email: user.primaryEmailAddress.emailAddress, username: user.username, ...data }
          ...
          <div className="container mx-auto bg-white  mt-10 rounded px-4">
            <div className="xl:w-full border-b border-gray-300 dark:border-gray-700 py-5">
              <div className="flex w-11/12 mx-auto xl:w-full xl:mx-0 items-center">
                <p className="text-lg text-gray-800  font-bold">Category Information</p>
